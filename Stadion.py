...
class Stadion:
    def __init__(self,nev:str="",varos:str="",csapatok_szama:int=0,elso_merk:str="",utolso_merk:str=""):
        ...
        """itt le kellene kezelni, ha nem számot kap,akkor mi van"""
        self.elso_merk=elso_merk=datetime.strptime(elso_merk, "%Y-%m-%d")
        self.utolso_merk=utolso_merk=datetime.strptime(utolso_merk, "%Y-%m-%d")
